...
import { LoginSimulator } from "@/components/LoginSimulator"; // Add this import
    ...
    <div className="bg-white font-inter">
      ...
      >
        ...
        <div className="w-1/2 h-full hidden lg:flex items-cover justify-center">
          <Image src={heroImage} alt="Fresh Food" className="object-cover w-1/2 h-auto rounded-lg top-2" />
        </div>
        ...
        <div className="relative w-full object-contain lg:w-1/2 text-center lg:text-left max-w-3xl">
          ...
          <div className="absolute inset-0 w-full h-full flex justify-end items-center -right-64 z-0">
            <Image src={fresh} alt="Fresh Food" className="w-[400px] h-auto object-contain rounded-xl opacity-90" />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-8 text-center">
        ...
        <div className="flex flex-wrap justify-center items-center gap-12 mt-8">
          <div className="max-w-xs flex flex-col items-center text-center">
            <Image className="object-contain" src={one} alt="Healthy Food" width={120} height={120} />
          ...
          <div className="max-w-xs flex flex-col items-center text-center">
            <Image className="object-contain" src={two} alt="Best Chefs" width={120} height={120} />
          ...
          <div className="max-w-xs flex flex-col items-center text-center">
            <Image className="object-contain" src={three} alt="Fast Delivery" width={120} height={120} />
      ...
      <section className="bg-[#F0FFF0] py-[100px] px-8 flex flex-col lg:flex-row items-center justify-center text-center lg:text-left">
        <div className="w-full lg:w-1/2 flex flex-col gap-4 lg:pl-28">
          ...
          <div className="flex flex-col lg:flex-col items-center lg:items-start mt-6 gap-5">
            ...
            <Image className="object-contain mt-4" src={qr} alt="qr code" width={120} height={120} />
          </div>
        </div>
        <div className="w-full lg:w-1/2 flex items-center justify-center mt-8 lg:mt-0">
          <Image src={appMockup} alt="App Mockup" className="w-[80%] max-w-[600px] h-auto object-contain" />
        </div>
      </section>
      ...
      <section className="py-16 px-8 text-center">
        ...
        <div className="flex flex-wrap justify-center items-center gap-12 mt-8">
          <div className="max-w-xs flex flex-col items-center text-center">
            <Image className="object-contain" src={vendor} alt="vendor" width={170} height={170} />
            <h3 className="text-2xl text-[#FF6600] font-semibold mt-4">Register as Vendor</h3>
            <p className="text-[#1A1A1A]">Enjoy delicious food from a variety of restaurants near you!</p>
          </div>
          <div className="max-w-xs flex flex-col items-center text-center">
            <Image className="object-contain" src={dispatch} alt="dispatch" width={170} height={170} />
